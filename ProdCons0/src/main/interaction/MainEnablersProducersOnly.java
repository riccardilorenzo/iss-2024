...
public void configureTheSystem()  {
    ...
    ProducerUsingConnection producer1 = new ProducerUsingConnection("lorenzoriccardi", host, port,protocol );
    ProducerUsingConnection producer2 = new ProducerUsingConnection("lorenzoriccardi", host, port,protocol );
